...
class Pay::LemonSqueezy::Webhooks::SubscriptionPaymentSucceededTest < ActiveSupport::TestCase
  setup do
    @data = OpenStruct.new JSON.parse(File.read("test/support/fixtures/lemon_squeezy/subscription_payment_succeeded.json"))
  ...
  test "a charge is created" do
    ...
    assert_difference "Pay::Charge.count" do
      ...
      Pay::LemonSqueezy::Webhooks::SubscriptionPaymentSucceeded.new.call(@data)
    end
