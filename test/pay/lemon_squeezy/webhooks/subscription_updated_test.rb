...
class Pay::LemonSqueezy::Webhooks::SubscriptionUpdatedTest < ActiveSupport::TestCase
  setup do
    @data = OpenStruct.new JSON.parse(File.read("test/support/fixtures/lemon_squeezy/subscription_updated.json"))
  ...
  test "nothing happens if a subscription can't be found" do
    ...
    Pay::LemonSqueezy::Webhooks::SubscriptionUpdated.new.call(@data)
  end
